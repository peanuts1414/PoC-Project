...
ただし、情報漏洩を考慮し公開するデータは特徴量を正規化処理したあとのデータになります。
また、異常データは実際に起こりえるケースを想定し、スケール調整などを行い疑似異常を作成しました。
...
上記のグラフは、使用したモータ速度パターンを示すイメージ図になります。\
パターンは2種類になります。\
...
上記の図は周期についてのイメージ図になります。周期一つにつきモータがワンサイクルしているイメージです。\
